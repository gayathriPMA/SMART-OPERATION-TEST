describe('Smoke Suite', () => {
    ...
    it('Dashboard Screen', () => {
        ...
        /* check status code */
        cy.wait('@getDashboardData', { timeout: 10000 }).its('response.statusCode').should('eq', 200);
    ...
    it('Department Screen: API Interaction', () => {
        ...
        /* verify status code */
        cy.wait('@getDepartments', { timeout: 10000 }).its('response.statusCode').should('eq', 200);
    });
});